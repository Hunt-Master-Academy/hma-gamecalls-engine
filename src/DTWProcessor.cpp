...
namespace huntmaster
{
    ...
    float DTWProcessor::euclideanDistanceSquared(const std::vector<float> &v1, const std::vector<float> &v2)
    {
        float distance = 0.0f;
    ...
    float DTWProcessor::calculateDistance(const std::vector<std::vector<float>> &seq1, const std::vector<std::vector<float>> &seq2)
    {
