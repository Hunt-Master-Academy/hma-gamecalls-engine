...
class MFCCErrorPathTest : public ::testing::Test {
  protected:
    void SetUp() override {
        // Set up a valid baseline configuration
        valid_config.frame_size = 2048;
        valid_config.hop_size = 512;
        valid_config.sample_rate = 44100.0f;
        valid_config.n_mels = 40;
        valid_config.n_mfcc = 13;
        valid_config.low_freq = 0.0f;
        valid_config.high_freq = 8000.0f;
        valid_config.preemph_coeff = 0.97f;
        valid_config.lifter_coeff = 22;
        valid_config.use_energy = true;
        valid_config.use_power = true;
        valid_config.energy_floor = 1e-10f;
